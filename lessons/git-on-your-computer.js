  ...
  // Does the user actually see the visualization mentioned below?
    ...
    lessonText:
      <div>
        ...
        <p>You'll see this folder being added to your current directory above.</p>
      </div>,
    buttonText: 'Done!',
    buttonFunction() {
    ...
    errorMessage: "Oops! It looks like you haven't created a new directory called 'new-project'. Try again and then click the button below.",
    ...
    lessonText:
      <div>
        ...
        <p>Now type <code>cd new-project</code> and click Enter to navigate to your new directory. (The "cd" command is short for "change directory.") This is where you'll  store all the files for your project.</p>
      </div>, // '
    buttonText: 'Got it!',
    buttonFunction() {
    ...
    errorMessage: "Oops! It looks like you haven't navigated into the 'new-project' directory. Try again and then click the button below.",
    ...
    errorMessage: "Oops! It looks like you haven't created a file called 'new-file.txt', or you aren't inside the 'new-project' directory. Try again and then click the button below.",
    ...
    errorMessage: "Oops! It looks like you haven't initialized your repo, or you aren't inside the 'new-project' directory. Try again and then click the button below.",
    ...
    errorMessage: "Oops! It looks like you haven't added new-file.txt to your staging area, or you aren't inside the 'new-project' directory. Try again and then click the button below.",
    ...
    errorMessage: "Oops! It looks like you have changes that you haven't committed, or you aren't inside the 'new-project' directory. Try again and then click the button below.",
    ...
    errorMessage:
    "Oops! It looks like you haven't made any changes to new-file.txt since your last commit, or you aren't inside the 'new-project' directory. Try again and then click the button below.",
